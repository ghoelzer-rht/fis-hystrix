...
1. Now lets review some of the key configurations we already have in place such as *Readiness and Liveness Probes* and create and setup our *definition* microservice for *auto-scaling*.
+
