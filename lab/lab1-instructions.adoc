...
1. Now lets setup *Auto-Scaling* for the *definition* microservice.  As part of this step will we will review how to define *Resource Requests and Limits*, and have a brief discussion on the K8S *Quality of Service* assigned to Pods.
+
