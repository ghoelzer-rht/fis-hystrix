...
+
Now hit the definition API a bunch of times from the Swagger API Console and you should now see that the circuit breaker has *closed* due to the number of failures of the definition API as displayed below:
+
